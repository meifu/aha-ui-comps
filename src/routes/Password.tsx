    ...
    <div className="flex flex-none items-center py-1 mb-2 last:mb-0">
      {
        passed ?
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" className="w-6 h-6 stroke-zinc-500">
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
          </svg>
      }
      <span className="leading-6 ml-3">{rule.msg}</span>
    </div>
  )
}
