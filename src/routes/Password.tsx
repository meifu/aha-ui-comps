...
function RuleCheck({ value = '', rule = { regex: /./g, msg: ''} }: RuleCheckType) {
  ...
  return (
    <div className="flex flex-none items-center py-1 mb-2 last:mb-0">
      {
        passed ?
          <svg width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-testid={`${msg}-pass`}>
            <circle cx="12" cy="12" r="10.5" className="fill-sky-500"/>
            <polyline points="6.27 12 10.09 15.82 17.73 8.18" className="stroke-2 stroke-neutral-800 fill-none"/>
          </svg> :
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" className="w-6 h-6 stroke-zinc-500" data-testid={`${msg}-fail`}>
...
export default function Password() {
  ...
  return (
    <div className="max-w-md">
      <label htmlFor="pw" className="relative inline-block text-sm bg-black p-1 -bottom-4 left-3">Password</label>
      <input
        id="pw"
        name="pw"
        type="password"
